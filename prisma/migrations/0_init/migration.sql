...
-- AddForeignKey
ALTER TABLE "questionnaire_assignment" ADD CONSTRAINT "questionnaire_assignment_assigned_by_fkey" FOREIGN KEY ("assigned_by") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
