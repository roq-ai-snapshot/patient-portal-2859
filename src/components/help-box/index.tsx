...
6. As a Clinic Owner, I want to create questionnaires so that Medical Professionals can use them to collect patient data.
...
8. As a Patient, I want to upload documents so that I can share them with the clinic.

9. As a Patient, I want to fill out questionnaires so that I can provide the clinic with necessary medical data.

10. As a Patient, I want to send messages to the clinic so that I can communicate with them about my medical needs.

11. As a Clinic Administrator, I want to transfer questionnaire data to our internal medical record system so that we can maintain accurate patient records.`;
